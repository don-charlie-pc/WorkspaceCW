...
/*********************						Defines							**********************/
/*************************************************************************************************/
#define INITIAL_STATUS_CONFIG 0b00110000
#define INITIAL_CLK_CONFIG 0
#define START_MASK 0x0EF
#define STOP_MASK 0x10
#define NOT_RUNNING_MASK 0x10
#define RESET_MASK 0x20
#define MAX_PRESCALER_OPTION 8
#define CLEAR_PRESCALER_MASK 0x0F0
#define MAX_CLK_OPTION 3
#define CLEAR_CLK_MASK 0x0CF
#define ENABLE_INTERRUPT_MASK 0x40
#define DISABLE_INTERRUPT_MASK 0x0BF
/*************************************************************************************************/
/*********************						Typedefs						**********************/
/*************************************************************************************************/
...
{
	MTIMSC |= ENABLE_INTERRUPT_MASK;
}

void MTIM_InterruptOff(void)
{
	MTIMSC &= DISABLE_INTERRUPT_MASK;
}
...
interrupt 12 void MTIM_ISR(void)
{
	...
	{
		//Stop and reset when max number of flags per delay are reached
		sgu8flagCounter = 0;
		MTIMSC |= RESET_MASK;
		MTIMSC |= STOP_MASK;
	}
